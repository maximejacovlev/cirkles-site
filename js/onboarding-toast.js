...
(function () {
  ...
  function injectStyles() {
    var css =
      ".onboarding-toast{position:fixed;top:20px;right:20px;z-index:320;display:flex;align-items:center;gap:14px;" +
      "max-width:340px;padding:14px 16px 14px 18px;border-radius:18px;" +
      ...
      ".onboarding-toast .ot-text{font-size:13px;font-weight:500;color:#000;line-height:1.4;margin:0;}" +
      ".onboarding-toast .ot-yes{flex-shrink:0;display:inline-flex;align-items:center;justify-content:center;" +
      ...
      ".onboarding-toast .ot-close{flex-shrink:0;width:26px;height:26px;border:none;border-radius:999px;" +
      "background:rgba(0,0,0,.06);color:rgba(0,0,0,.55);font-size:15px;line-height:1;cursor:pointer;" +
